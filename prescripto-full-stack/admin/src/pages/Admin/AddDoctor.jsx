                    ...
                    <div className='w-full lg:flex-1 flex flex-col gap-4'>
                        ...
                        <div className='flex-1 flex flex-col gap-1'>
                            ...
                            <select onChange={e => setSpeciality(e.target.value)} value={speciality} className='border rounded px-2 py-2'>
                                ...
                                <option value="CardiothoracicSurgeon">CardiothoracicSurgeon</option>
                                <option value="CardiacSurgeon">CardiacSurgeon</option>
                                <option value="InterventionalCardiologist">InterventionalCardiologist</option>
                                <option value="PediatricCardiologist">PediatricCardiologist</option>
